...
public enum FasterWorldScanner implements IWorldScanner {
    ...
    private void visitSection(BlockOptionalMetaLookup lookup, LevelChunkSection section, List<BlockPos> blocks, long chunkX, long chunkZ, int sectionIndex) {
